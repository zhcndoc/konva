...
try {
  ...
  // This fork serves its independently maintained Chinese UI from the default
  // locale. Leaving the generated English catalog behind would override those
  // source messages on the next build.
  fs.rmSync(englishRoot, { recursive: true, force: true });
}
