---
title: Konva API Reference
sidebar_label: Konva
slug: /api/Konva.html
sidebar_position: 1
description: "Complete API reference for Konva.js — Stage, Layer, Shape, Node, Transformer, and all core classes. Browse methods, properties, and events for the HTML5 Canvas framework."
---
