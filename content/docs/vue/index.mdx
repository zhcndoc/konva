...
slug: index.html
description: "开始使用 vue-konva，这是 Konva.js 的官方 Vue 绑定。绘制形状、处理事件并使用 Vue 组件构建交互式画布应用程序。"
---
...
完成全局注册后，所有组件都可通过带有 `v-` 前缀的名称使用，比如：`v-stage`、`v-layer`、`v-rect`、`v-circle` 等。
