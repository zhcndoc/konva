...
sidebar_label: 10,000 Shapes with Tooltips
hide_table_of_contents: true
slug: 10000_Shapes_with_Tooltip.html
description: "Stress test rendering 10,000 circles on canvas with interactive tooltips showing shape info on hover using Konva."
---
