---
title: Canvas 调整图像大小 — 使用 JavaScript 拖动、放置和调整图像大小
sidebar_label: 图像调整大小
hide_table_of_contents: true
slug: Image_Resize.html
description: "了解如何使用 JavaScript 在 HTML5 Canvas 上调整图像大小。使用 Konva.js 通过角落锚点拖动、放置并缩放图像。带有源代码的交互式演示。"
---

此演示展示了如何通过实现可拖动的角落锚点来调整画布上的图像大小。图像既可以被拖动，也可以被调整大小——这是画布图像编辑中的一种常见模式。
