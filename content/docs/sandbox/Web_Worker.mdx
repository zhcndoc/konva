...
description: "使用 OffscreenCanvas 在 Web Worker 内部运行 Konva 渲染，以实现非主线程性能。"
---

## 如何在 Web Worker 中运行 Konva？

**警告！这个演示是非常实验性的！可能在许多浏览器中无法正常工作。** 请查看 [OffscreenCanvas 兼容性表](https://caniuse.com/#feat=offscreencanvas)。
