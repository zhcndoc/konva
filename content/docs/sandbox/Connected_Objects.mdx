...
description: "Learn how to connect shapes with lines or arrows on HTML5 Canvas with Konva.js. Build flowcharts, diagrams, and node editors with draggable connected objects."
---
