---
title: How to Build an Interactive Floor Plan with JavaScript Canvas
layout: demo_page
hide_table_of_contents: true
slug: Interactive_Building_Map.html
description: "Build an interactive building floor plan with JavaScript and HTML5 Canvas using Konva.js. Hover over sections to see descriptions in this interactive map demo."
---
