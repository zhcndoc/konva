...
If you want to show complex styles on canvas, you can use [render-tag](https://polotno.com/render-tag/) — a library that renders HTML + CSS directly onto canvas using the 2D API. No SVG, no `foreignObject`, fully synchronous.
