---
title: Canvas Zoom and Pan — Zoom Relative to Pointer Position
sidebar_label: Zooming Relative To Pointer
hide_table_of_contents: true
slug: Zooming_Relative_To_Pointer.html
description: "Implement canvas zoom and pan with JavaScript. Zoom in and out relative to mouse pointer position using scroll wheel on a Konva stage."
---
