---
title: Canvas Drawing — Free Drawing and Painting on HTML5 Canvas with JavaScript
sidebar_label: Canvas Drawing
hide_table_of_contents: true
slug: Free_Drawing.html
description: "Draw on an HTML5 Canvas with JavaScript. Build a canvas drawing app with freehand strokes, pen tools, and eraser using Konva.js. Two approaches: vector graphics and manual 2D drawing."
---
