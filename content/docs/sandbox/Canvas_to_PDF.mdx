---
title: How to Export HTML5 Canvas to PDF with JavaScript
sidebar_label: Canvas to PDF
hide_table_of_contents: true
slug: Canvas_to_PDF.html
description: "Convert and export an HTML5 Canvas to PDF with JavaScript using Konva.js and jsPDF. Includes selectable text, high-quality image rendering, and one-click download."
---
