...
Use this minimal async function that combines the native Font Loading API with a reliable width-measurement fallback and timing guard:
...
loadFont('Kavivanar', 'normal', '400').then(() => {
  // Build our stage after font is loaded
  ...
  var text = new Konva.Text({
    ...
    width: 250,
    fontFamily: 'Kavivanar', // Font is guaranteed to be loaded
  });
