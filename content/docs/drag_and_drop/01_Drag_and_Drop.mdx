...
description: "Learn how to add drag and drop to HTML5 Canvas shapes with Konva.js. Make any shape draggable with a single property and handle drag events."
---
