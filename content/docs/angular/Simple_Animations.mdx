...
description: "学习如何使用 ng2-konva 和 Konva.Animation 类在 Angular 中创建简单的 canvas 动画。"
---
...
了解更多详情，请参阅 [动画文档](/docs/animations/Rotation.html) 和 [节点 API 参考](/api/Konva.Node.html)。
