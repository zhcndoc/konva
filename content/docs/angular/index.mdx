...
`ng2-konva` is a JavaScript library for drawing complex canvas graphics using [Angular](https://angular.io/). It provides declarative and reactive bindings to the [Konva Framework](https://konvajs.org/).

[Github Repo](https://github.com/konvajs/ng2-konva)

It is an attempt to make [Angular](https://angular.io/) work with the HTML5 canvas library. The goal is to have a similar declarative markup as normal Angular and also a similar data-flow model.
...
[Angular](https://angular.io/) version 20+ is required.
