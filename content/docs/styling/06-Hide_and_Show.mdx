---
title: HTML5 Canvas 隐藏和显示形状教程
sidebar_label: 隐藏和显示
hide_table_of_contents: true
slug: Hide_and_Show.html
description: "学习如何使用 Konva.js 的 hide() 和 show() 方法在 HTML5 Canvas 上切换形状可见性。"
---

使用 Konva 隐藏和显示形状时，我们可以在实例化形状时设置 visible 属性，或者使用 `hide()` 和 `show()` 方法。
