...
description: "Get started with react-konva, the official React binding for Konva.js. Draw shapes, handle events, drag-and-drop, and animate on HTML5 Canvas using React components."
---
