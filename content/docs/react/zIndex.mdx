...
slug: zIndex.html
description: "了解如何通过管理组件状态而不是手动 z-ordering 来控制 react-konva 中的 zIndex 和重新排列形状。"
---
...
如果你想暂时将一个节点移动到另一个容器中，例如在你想显示一个覆盖层时，可以查看 [Canvas Portal 演示](/docs/react/Canvas_Portal.html)。
