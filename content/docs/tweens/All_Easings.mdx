...
description: "查看所有 Konva.js 缓动函数的实际效果：Linear、Ease、Back、Elastic、Bounce 和 Strong，并配有交互式演示。"
---
...
如需查看所有可用的缓动函数，请前往[缓动函数文档](/api/Konva.Easings.html)。

**说明：按下“Play”以使用不同的缓动函数过渡所有文本节点。**
