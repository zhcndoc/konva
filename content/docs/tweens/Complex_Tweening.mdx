---
title: 复杂补间动画教程
sidebar_label: 复杂补间动画
hide_table_of_contents: true
slug: Complex_Tweening.html
description: "了解如何在 Konva.js 中创建复杂的补间动画，包括渐变过渡和串联补间动画。"
---

此演示将串联的 `Konva.Tween` 实例与 `Konva.Animation` 结合使用。
补间动画会改变圆形的缩放比例。动画会改变
`fillLinearGradientColorStops` 属性。

**说明：点击图形以启动带有渐变变化的复杂动画。**
