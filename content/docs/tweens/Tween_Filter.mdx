...
description: "学习如何使用 Konva.js 补间动画模糊半径等滤镜属性，以实现图像上的平滑滤镜过渡。"
---

要使用 Konva 实现滤镜补间，我们只需对与滤镜关联的属性进行补间。
在本教程中，我们将对 `blurRadius` 属性进行补间，该属性控制应用于图像的模糊程度。

**说明：将鼠标悬停或触摸图像以聚焦它（减少模糊）。**
