...
description: "学习如何在移动设备上使用 Konva.js 处理 HTML5 Canvas 上的触控事件。支持 tap、touchstart、touchmove、touchend 以及多点触控手势。"
---
...
对于更复杂的手势，例如旋转，可以查看 [手势演示](/docs/sandbox/Gestures.html)。

如果你需要整体舞台的平移和缩放逻辑，可以参考 [多点触控缩放舞台演示](/docs/sandbox/Multi-touch_Scale_Stage.html)。
