...
description: "Learn how to use event delegation on HTML5 Canvas with Konva.js. Listen for events on layers or groups instead of individual shapes for cleaner code."
---
