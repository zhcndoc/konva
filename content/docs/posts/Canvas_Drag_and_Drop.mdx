...
description: "使用指针事件、命中检测以及 JavaScript 或 React 中的 Konva 可拖动节点实现 Canvas 拖放。"
---
...
请参阅[拖放指南](/docs/drag_and_drop/Drag_and_Drop.html)，其中提供了 Vanilla、React、Vue、Svelte 和 Angular 示例。
