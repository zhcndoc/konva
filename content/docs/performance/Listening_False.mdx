...
description: "Boost HTML5 Canvas performance with Konva.js by disabling event listening on shapes that don't need interaction. Set listening:false to skip hit detection."
---
