...
sidebar_label: 调整大小限制
hide_table_of_contents: true
slug: Resize_Limits.html
description: "了解如何在使用 Konva.js Transformer 调整 HTML5 Canvas 上的形状大小时设置最小和最大尺寸限制"
---

要限制或更改调整大小和变换行为，可以使用 `boundBoxFunc` 属性
它的工作方式与 [dragBoundFunc](/docs/drag_and_drop/Simple_Drag_Bounds.html) 有些类似

**说明：尝试调整形状的大小。你会看到它的宽度被限制为 200**

你还可以单独控制每个锚点的移动。请参阅 [Resize Snap Demo](https://konvajs.org/docs/select_and_transform/Resize_Snaps.html)
