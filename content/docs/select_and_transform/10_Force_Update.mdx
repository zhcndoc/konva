---
title: HTML5 Canvas Force Update 教程
sidebar_label: Force Update
hide_table_of_contents: true
slug: Force_Update.html
description: "当无法自动检测组中的深层变化时，使用 forceUpdate 手动刷新 Konva Transformer"
---

`Konva.Transformer` 会自动跟踪所附加节点的属性
因此它也会自动更新自身的属性

但在某些情况下，`Konva.Transformer` 无法做到这一点。目前，`Konva.Transformer` 无法跟踪 `Konva.Group` 节点内部的深层变化。在这种情况下，你需要使用 `forceUpdate` 方法来重置变换工具
