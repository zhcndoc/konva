---
title: 相对于中心调整 HTML5 Canvas 形状大小
sidebar_label: 居中缩放
hide_table_of_contents: true
slug: Centered_Scaling.html
position: 2
description: "了解如何使用 Konva Transformer's centeredScaling 属性或 ALT 键从中心调整形状大小。"
---

要同时向两侧调整节点大小，可以将 `centeredScaling` 设置为 true，或者在移动锚点时按住 `ALT` 键（即使 `centeredScaling` 为 false）。
