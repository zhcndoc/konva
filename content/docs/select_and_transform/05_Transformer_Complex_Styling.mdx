...
description: "使用 anchorStyleFunc 对 Konva Transformer 的每个锚点进行高级样式设置，包括自定义大小和可见性。"
---

你可以使用 `Konva.Transformer` 的 `anchorStyleFunc` 属性，以更深入地控制锚点的样式。

对于更简单的使用场景，也可以查看 [Transformer 样式](/docs/select_and_transform/Transformer_Styling.html)。
