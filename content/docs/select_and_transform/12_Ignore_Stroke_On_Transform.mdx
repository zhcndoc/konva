---
title: 如何在画布上调整形状大小而不改变其描边大小？
sidebar_label: 忽略描边
hide_table_of_contents: true
slug: Ignore_Stroke_On_Transform.html
description: "使用 Konva Transformer 的 ignoreStroke 和 strokeScaleEnabled 在形状调整大小时防止描边宽度缩放。"
---

请记住，`Konva.Transformer` 会更改节点的 `scaleX` 和 `scaleY` 属性。
默认情况下，如果您变换一个形状，其描边也会被缩放。在某些情况下，这不是理想的行为。
