...
sidebar_label: 调整大小吸附
hide_table_of_contents: true
slug: Resize_Snaps.html
description: "在 Konva Transformer 中使用 anchorDragBoundFunc 将形状调整大小的锚点吸附到参考线。"
---

在某些应用程序中，您可能希望将调整大小操作吸附到某些特定值附近。吸附功能使形状在指定值附近具有“粘性”，效果类似于取整。
