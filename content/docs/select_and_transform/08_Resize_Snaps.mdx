---
title: HTML5 Canvas 形状缩放吸附
sidebar_label: 缩放吸附
hide_table_of_contents: true
slug: Resize_Snaps.html
description: "使用 Konva Transformer 中的 anchorDragBoundFunc 将形状缩放锚点吸附到指引线"
---

在某些应用中，您可能希望将缩放吸附到某些值附近。吸附会使形状在指定值附近“粘滞”，其工作方式类似于四舍五入
您可以使用 [anchorDragBoundFunc](/api/Konva.Transformer.html#anchorDragBoundFunc) 方法控制锚点位置行为
...
**说明：尝试缩放一个形状。您将看到 transformer 如何尝试吸附到指引线。**
