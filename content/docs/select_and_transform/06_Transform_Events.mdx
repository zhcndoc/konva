---
title: HTML5 Canvas 变换和调整大小事件
sidebar_label: 变换事件
hide_table_of_contents: true
slug: Transform_Events.html
description: "了解如何使用 Konva.js Transformer 监听 HTML5 Canvas 上的变换和调整大小事件。处理 transformstart、transform 和 transformend。"
---

`Konva.Transformer` 对象具有特殊的变换事件，您可以在应用程序中使用这些事件：`transformstart`、`transform` 和 `transformend`。
