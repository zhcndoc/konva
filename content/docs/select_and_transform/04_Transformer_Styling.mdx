...
description: "通过更改锚点填充色、描边、大小、边框颜色和圆角半径来自定义 Konva Transformer 的外观。"
---

你可以为 Web 应用调整 `Konva.Transformer` 的样式。你可以更改所有锚点的描边、大小和填充色。
你还可以更改边框的描边颜色和大小。

有关详细调整，请参阅[复杂 Transformer 样式](/docs/select_and_transform/Transformer_Complex_Styling.html)。
